...
import { Progress } from "./tts";
import { processSentences, downloadModel } from "./tts-manager";
...
function InitPhase({
  ...
  async function init() {
    ...
    await downloadModel();
    setPhase("model-ready");

    const sentences = await getText();
    setPhase("processing-sentences");
